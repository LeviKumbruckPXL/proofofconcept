var Ot=Object.defineProperty;var Bt=(a,s,e)=>s in a?Ot(a,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[s]=e;var w=(a,s,e)=>(Bt(a,typeof s!="symbol"?s+"":s,e),e);import{Base as Xs,AjaxHelper as Rt,ArrayHelper as ge,BrowserHelper as F,Delayable as ei,DomHelper as R,EventHelper as Le,Events as ti,Mask as si,ObjectHelper as ii,Rectangle as Dt,Scroller as ai,Splitter as ri,StringHelper as Ie,TextField as ni,Toast as Nt,Tooltip as Pt,VersionHelper as oi,Widget as fe}from"./setup.js";import{Base as jt}from"./setup.js";var Me={category:1,classDescription:1,constructor:1,defaultvalue:1,demo:1,description:1,feature:1,lineno:1,longname:1,name:1,path:1,scope:1,typings:1,examples:1,xes:1,externalExamples:1,nonMixin:1,nonFeature:1,noClassType:1,typingsWidget:1,internalWidget:1,hideConfigs:1,hideProperties:1,hideEvents:1,hideFields:1,hideFunctions:1,extendsconfigs:1,extendsConfigs:1,typingswidget:1,widget:1,uninherit:1},O=class extends jt{static diff(s,e){return this.diffs=[],this.compareArrays(s,e),this.diffs}static compareArrays(s=[],e=[],t=""){typeof s[0]=="object"||typeof e[0]=="object"?(s.forEach(i=>{var n;if(i.access)return;t||(this.currentModule=((n=i.name)==null?void 0:n.split(":")[1])||i.name);let r=e.find(l=>l.name===i.name&&this.isSameScope(l.scope,i.scope));r?this.compareObject(i,r,t+"/"+i.name):this.diffs.push({status:"removed",left:i.name,name:i.name,path:t.split(":")[1]||i.name,module:this.currentModule})}),e.filter(i=>!i.access&&!s.find(r=>i.name===r.name)).forEach(i=>{var n;let r=i.scope==="static";t||(this.currentModule=((n=i.name)==null?void 0:n.split(":")[1])||i.name),this.diffs.push({status:"new",right:this.getDisplayValue(i.name),name:i.name+(r?"-static":""),path:t.split(":")[1]||i.name,module:this.currentModule})})):(e=Array.isArray(e)?e:[e],this.compareValues(s.join(", "),e.join(", "),t))}static isSameScope(s,e){return s=s==="static"?s:"instance",e=e==="static"?e:"instance",s===e}static compareObject(s,e,t){var i,r;if(!((i=s.name)!=null&&i.startsWith("is")&&((r=s.description)!=null&&r.startsWith("Identifies an object as an instance of")))){for(let n in s){if(n in Me||s.access)continue;let l=s[n],o=e[n];!(n in e)&&!Array.isArray(l)?this.diffs.push({status:"removed",name:n,left:l,path:t.split(":")[1],module:this.currentModule}):(n==="returns"?(l=l.type,o=o==null?void 0:o.type):n==="parameters"&&t.match(/functions/)&&(l=l.map(c=>`${c.name}:${c.type}`).join(", "),o=o==null?void 0:o.map(c=>`${c.name}:${c.type}`).join(", ")),this.compareValues(l,o,t+"/"+n))}for(let n in e)n in Me||e.access||(!(n in s)&&!Array.isArray(e[n])?n==="deprecated"?this.diffs.push({status:"deprecated",name:n,path:t.split(":")[1],module:this.currentModule}):n!=="isConfig"&&n!=="isProp"&&this.diffs.push({status:"new",name:n,right:this.getDisplayValue(e[n]),path:t.split(":")[1],module:this.currentModule}):n in s||this.compareValues(s[n]||[],e[n],t+"/"+n))}}static compareValues(s,e,t){if(s!==e){if(Array.isArray(s)){this.compareArrays(s,e,t);return}s!==e&&this.diffs.push({status:"changed",name:t.substr(t.lastIndexOf("/")+1),left:this.getDisplayValue(s),right:this.getDisplayValue(e),path:t.split(":")[1]||t.substr(1),module:this.currentModule})}}static getDisplayValue(s){return Array.isArray(s)?typeof s[0]=="object"?s.map(e=>e.name||e.type||e):s.join(", "):typeof s=="string"&&s.includes("#")?s.split(",").map(t=>t.includes("#")?t.includes(":")?t.replace(/:(.*)#/,":"):t.split("#")[1]:t).join(", "):s}};window.ApiDiffHelper=O;O._$name="ApiDiffHelper";import{GridBase as Wt}from"./setup.js";import{GridRowModel as Vt}from"./setup.js";var j=class extends Vt{static iconForGuide(s){let e=s.split("/"),t={Accessibility:"fas b-fa-universal-access","Alternative icon font":"fas b-fa-font",Angular:"fab b-fa-angular","Build for production":"fas b-fa-cog",Calendars:"fas b-fa-calendar-days","Class system":"fas b-fa-sitemap",Columns:"fas b-fa-table-columns","Catching changes":"fas b-fa-pen","Customize context menus":"fas b-fa-bars","Data binding":"fas b-fa-database","Displaying data":"fas b-fa-table","EcmaScript 6 bundle":"fas b-fa-box","Enabling features":"fas b-fa-wand-magic-sparkles",Events:"fas b-fa-bell","Import from sources":"fas b-fa-file-code",Ionic:"b-logo b-ionic","Listening for events":"fas b-fa-bell","JavaScript + npm":"fab b-fa-js",JavaScript:"fab b-fa-js","Keyboard shortcuts":"fas b-fa-keyboard",Localization:"fas b-fa-language","Multiple products":"fas b-fa-puzzle-piece","Node.js":"fab b-fa-node","Npm repository":"fab b-fa-npm","Preventable events":"fas b-fa-bell-slash",React:"fab b-fa-react","Replace context menus":"fas b-fa-bars","Resource histogram":"fas b-fa-chart-simple","Resource utilization":"fas b-fa-chart-bar",Responsive:"fas b-fa-mobile-screen",Salesforce:"fab b-fa-salesforce","Script tag":"fas b-fa-code",SharePoint:"fab b-fa-microsoft","Sizing the component":"fas b-fa-arrows-left-right-to-line","Source and demos":"fas b-fa-download","Store specification":"fas b-fa-scroll",Styling:"fas b-fa-palette","Time zone support":"fas b-fa-clock",Troubleshooting:"fas b-fa-bug","Upgrade FA icons to Pro":"fab b-fa-font-awesome-flag",Upgrading:"fas b-fa-circle-up","Using a Store":"fas b-fa-database","Using an AjaxStore":"fas b-fa-cloud","Using remote data":"fas b-fa-cloud","Using tree data":"fas b-fa-folder-tree",Vue:"fab b-fa-vuejs","What's new":"fas b-fa-star"},i="b-icon b-fa-book";for(let r of e)t[r]&&(i=t[r]);return i}get isModule(){return!!this.data.filename}get readableName(){return(this.fullName||this.name).replace(/\//g,".")}get guidesRecords(){let s=[],e=[];return this.traverse(t=>{t.isLeaf&&(t.parent===this?e.push(t):s.push(t))}),[...e,...s]}getGuideCategory(s,e=" - "){let t,i=this.parent;for(;i&&i!==s;)t=`${i.name}${t?`${e}${t}`:""}`,i=i.parent;return t}};w(j,"fields",["access","classDescription","description","deprecated","events","extends","filename","fields","folder","fullName","functions","href","type","isGuide","isGuideGroup","mixins","modulePath","private","props","singleton","virtual","isProp","isConfig","isAPI","isWidget","isView","sortAPIIndex","internalWidget"]);j._$name="DocsClass";var V=class extends Wt{static get configurable(){return{rowHeight:50,animateTreeNodeToggle:!1,hideHeaders:!0,readOnly:!0,emptyText:"",features:{cellEdit:!1,cellMenu:!1,columnAutoWidth:!1,columnPicker:!1,columnResize:!1,group:!1,headerMenu:!1,rowCopyPaste:!1,sort:!1,tree:{expandOnCellClick:!0},quickFind:{mode:"grid"}},store:{tree:!0,modelClass:j,sorters:[{field:"name",ascending:!0,fn(s,e){return!s.isAPI||!e.isAPI?0:s.isLeaf===e.isLeaf?s.sortAPIIndex!=null&&e.sortAPIIndex!=null?s.sortAPIIndex<e.sortAPIIndex?1:-1:null:s.isLeaf?1:-1}}]},columns:[{text:"Name",field:"name",width:150,type:"tree",htmlEncode:!1,indentSize:1,renderer({record:s,cellElement:e,row:t}){return s.data.type&&e.classList.add(s.data.type),t.assignCls({private:s.data.access==="private",deprecated:s.data.deprecated}),s.isModule&&e.classList.add("module"),s.isWidget&&e.classList.add("widget"),s.isView&&e.classList.add("view"),s.name}}]}}buildDocsTree(s){var l;let e=this,t=[],i={};Object.entries(e.navigation).forEach(o=>e.buildNavigationItem(t,o));let r=t.find(o=>o.id==="api");if(s.classes){r.children=[];for(let o of s.classes){o.isAPI=!0;let c=e.getParent(i,r.children,o.folder);c==null||c.children.push(o)}}r.children.forEach(o=>o.sortAPIIndex=window.bryntum.products.indexOf(o.id)),e.store.data=t;let n=e.store.find(o=>o.id==="widgets");n&&(n.appendChild(e.store.query(o=>o.isWidget).map(o=>{let c={...o.data};return c.href=`#widgets/${c.href.substring(1)}`,c.id=`widgets/${c.id}`,c})),(l=n.children)==null||l.sort((o,c)=>o.name.localeCompare(c.name))),window.bryntum.router.adjustStoreLinks(e.store)}getParent(s,e,t){if(!t)return null;if(s[t])return s[t];let i=t.split("/"),r="",n=null;return i.forEach((l,o)=>{r+=l;let c=s[r];c||(c=s[r]={id:r,name:l,children:[],isAPI:!0},n&&n.children.push(c),o===0&&e.push(c)),n=c,r+="/"}),n}buildNavigationItem(s,e,t){let[i,r]=e,n=!t,l=typeof r=="object",o=t?`${t.fullName}/`:"",c=l?`${o}${i}`:r,p=c.toLowerCase().replace(/['` ./]/g,"-"),u={fullName:c,name:i,iconCls:n?null:l?"":j.iconForGuide(`${o}${i}`),cls:"guide"+(n?" first-level":"")};l?(u.children=[],u.isGuide=!0,u.isGuideGroup=!0,u.id=p,u.href=`#${p}`,Object.entries(r).forEach(m=>{this.buildNavigationItem(u.children,m,u)})):r==="#engine"?(u.id="engineDocs",u.href="./engine/",u.target="_blank",u.iconCls="b-icon b-fa-external-link-alt"):r.startsWith("#")?(u.id=r.replace("#",""),u.href=r,u.fullName=i):(u.id=r,u.href=`#${r}`,u.isGuide=!0,u.isVersionHistory=r.endsWith("changelog.md")),s.push(u)}};w(V,"type","navigationtree"),w(V,"$name","NavigationTree");V._$name="NavigationTree";import{Container as _t}from"./setup.js";var J=class extends _t{static get configurable(){var s;return{adopt:"tools",settings:null,items:[{tag:"a",id:"upgradesButton",cls:"b-upgrade-guide-button",html:"Upgrades",elementAttributes:{href:"#upgrade-guide"}},{tag:"a",html:"Support",elementAttributes:{href:"https://bryntum.com/support/"}},{tag:"a",ref:"examplesLink",html:"Examples",elementAttributes:{href:"../examples",target:"_blank"}},{tag:"a",id:"guidesLink",ref:"guidesLink",html:"Guides",elementAttributes:{href:"#guides"}},{type:"button",id:"menu-button",ref:"showMembersButton",ariaLabel:"Menu",text:"Show",cls:"b-transparent",ripple:null,menu:{ref:"showMembersMenu",width:270,anchor:!0,items:[{ref:"showPublic",name:"showPublic",checked:!0,text:"Show public members"},{ref:"showInternal",name:"showInternal",checked:!1,text:"Show internal members"},{ref:"showPrivate",name:"showPrivate",checked:!1,text:"Show private members"},{ref:"showInherited",name:"showInherited",checked:!0,text:"Show inherited members",separator:!0},{ref:"showAdvanced",name:"showAdvanced",checked:!1,text:"Show advanced APIs",separator:!0},{ref:"groupMembers",name:"groupMembers",checked:!0,text:"Group members",separator:!0}],onToggle:"up.onShowMenuItemToggle",onBeforeShow:"up.onBeforeShowMenuShow"}},{id:"downloadTrial",type:"button",html:"Free Trial",cls:"b-raised b-green",hidden:!((s=window.bryntum.router)!=null&&s.isOnline),href:"https://bryntum.com/download/"}]}}onShowMenuItemToggle({source:s}){if(s.isVisible){let e={};s.owner.items.forEach(t=>{e[t.name]=t.checked}),this.trigger("settingsChange",{settings:e})}}onBeforeShowMenuShow(){let{settings:s}=this,e=this.widgetMap.showMembersButton.menu.widgetMap;e.showPublic.checked=s.showPublic,e.showInternal.checked=s.showInternal,e.showPrivate.checked=s.showPrivate,e.showAdvanced.checked=s.showAdvanced,e.showInherited.checked=s.showInherited,e.groupMembers.checked=s.groupMembers}};w(J,"$name","Tools");J._$name="Tools";import{Container as Ut,StringHelper as $,Store as je,TemplateHelper as Pe,DomSync as Re,VersionHelper as $e}from"./setup.js";import{Widget as Gt}from"./setup.js";var z=class extends Gt{compose(){return{class:"search-placeholder",tabindex:0,children:[{children:[{tag:"i",class:"b-icon b-fa b-fa-search"},{tag:"span",html:"Quick search..."}]},{tag:"span",class:"search-shortcut",html:"/"}],listeners:{click:"showSearch",keydown:s=>{s.key==="Enter"&&this.showSearch()}}}}showSearch(){this.parent.showSearch()}};w(z,"$name","SearchPlaceholder");z._$name="SearchPlaceholder";import{StringHelper as qt}from"./setup.js";var ye=(a,s)=>a.every(e=>s.includes(e)),be=(a,s,e)=>e(a)&&!e(s)?-1:!e(a)&&e(s)?1:0,De=(a,s,e)=>{let t;if((t=be(a.type,s.type,i=>i==="class"))!==0)return t;if(e=e.toLowerCase().trim(),e!==""){let i=a.title.toLowerCase(),r=s.title.toLowerCase();if((t=be(i,r,n=>n===e))!==0)return t;if(e.includes(" ")){let n=e.split(" ");if((t=be(i,r,l=>ye(n,l)))!==0)return t}}return a.fullName<s.fullName?-1:1},W=({description:a})=>{var s,e;if(a)return a.startsWith("<h2>Summary</h2>")?a.substring(16,280).replaceAll(/<.*?>/g,""):((e=(s=a.replaceAll(`
`," ").match(/<p>(.*?)<\/p>/))==null?void 0:s[1])==null?void 0:e.replaceAll(/<.*?>/g,""))||a.substring(0,160).replaceAll(/<.*?>/g,"")},Ne=(a,s,e)=>{var i,r,n,l,o,c;let t=[];for(let p of a.classes)if(p.access==="private"&&e.showPrivate||p.access==="internal"&&e.showInternal||(p.access==="public"||!p.access)&&e.showPublic){let u=p.fullName.replace(/\./g,"/");t.push({type:"class",cls:p.type,data:p,title:p.name,clsFullName:u,fullName:u,hash:p.fullName,deprecated:p.deprecated,description:W(p),isWidget:p.isWidget,isView:p.isView}),(i=p.functions)==null||i.forEach(m=>{m.hide||t.push({type:"function",data:p,title:m.name,clsFullName:u,fullName:u+"."+m.name,scope:m.scope,hash:p.fullName+"#function-"+m.name+(m.scope==="static"?"-static":""),deprecated:m.deprecated,description:W(m)})}),(r=p.configs)==null||r.forEach(m=>{m.hide||t.push({type:"config",data:p,title:m.name,clsFullName:u,fullName:u+"."+m.name,hash:p.fullName+"#config-"+m.name,deprecated:m.deprecated,description:W(m)})}),(n=p.fields)==null||n.forEach(m=>{m.hide||t.push({type:"field",data:p,title:m.name,clsFullName:u,fullName:u+"."+m.name,hash:p.fullName+"#field-"+m.name,deprecated:m.deprecated,description:W(m)})}),(l=p.properties)==null||l.forEach(m=>{m.hide||t.push({type:"property",data:p,title:m.name,clsFullName:u,fullName:u+"."+m.name,scope:m.scope,hash:p.fullName+"#property-"+m.name+(m.scope==="static"?"-static":""),deprecated:m.deprecated,description:W(m)})}),(o=p.events)==null||o.forEach(m=>{let{name:h}=m;if(!m.hide){t.push({type:"event",data:p,title:h,clsFullName:u,fullName:u+"."+h,hash:p.fullName+"#event-"+h,deprecated:m.deprecated,description:W(m)});let d="on"+qt.capitalize(h);t.push({type:"function",data:p,title:d,clsFullName:u,fullName:u+"."+d,hash:p.fullName+"#eventhandler-"+d,deprecated:m.deprecated,description:W(m)})}}),(c=p.typedefs)==null||c.forEach(m=>{m.hide||t.push({type:"typedef",data:p,title:m.name,clsFullName:u,fullName:u+"."+m.name,hash:p.fullName+"#typedef-"+m.name,deprecated:m.deprecated,description:W(m)})})}return t.push.apply(t,s.map((p,u)=>{var f,g,b;let m=(f=p.parent)==null?void 0:f.name,h=(b=(g=p.parent)==null?void 0:g.parent)==null?void 0:b.name,d;return!m&&!h?d=p.name:!h&&m?d=`${m}: ${p.name} `:h&&m&&(d=`${h}: ${m} - ${p.name} `),{type:"guide",data:p,iconCls:"b-fa b-fa-book",title:d,fullName:p.name,hash:p.data.id}})),t};var _=new je,Jt=new z,Oe=algoliasearch(window.bryntum.algoliaAppId,window.bryntum.algoliaSearchApiKey),pe=`${window.VersionHelper.getVersion(window.product)}_${window.productName.toLowerCase()}_index`,Be=a=>({results:a.map(()=>({hits:[],nbHits:0,nbPages:0,page:0,processingTimeMS:0,hitsPerPage:0,exhaustiveNbHits:!1,query:"",params:""}))}),zt={...Oe,search(a){return a.every(({params:s})=>!s.query)?($e.isTestEnv&&(window.bryntum.algoliaEmptySearchBlocked=!0),Promise.resolve(Be(a))):Oe.search(a).catch(s=>{if(s.message&&!/^Index.*does not exist$/i.test(s.message))return console.warn("Failed to fetch results, switching to offline results. Check if you have the latest version of Bryntum documentation and are connected to the internet to access online results.",s),Promise.resolve(Be(a))})}},B=instantsearch({indexName:pe,searchClient:zt,insights:!1,future:{preserveSharedStateOnUnmount:!0}}),ve={api:"API Docs",guide:"Guides",example:"Examples",offline:"Offline Results"},Qt=a=>a.map(s=>({id:s,label:ve[s]})),we=(a,s)=>{try{return new URL(a,s)}catch(e){return{}}},G=class extends Ut{construct(s){super.construct(...arguments);let e=this,{widgetMap:t}=e,{searchField:i,globalSearch:r,searchCategories:n,searchLoadingIndicator:l}=t,o=window.bryntum.docVersion||"1.0.0";localStorage.getItem("bryntumDocVersion")!==o&&(localStorage.removeItem("recentRecords"),localStorage.removeItem("recentSearchQueries"),localStorage.setItem("bryntumDocVersion",o)),_.on({filter(){_.sort({fn(p,u){return De(u,p,i.value)},ascending:!1})}}),e.initializeOnlineSearch(),r.on("show",()=>i.focus()),i.on({thisObj:e,input:{fn:({value:p})=>{e.onSearchInput(p)},throttle:200},clear:()=>e.onSearchInput("")}),n.on("beforeItem",p=>e.onCategoryClick(p)),B.on("render",()=>{B.status==="loading"||B.status==="stalled"?l.show():l.hide()}),e.searchInstance=B,window.addEventListener("hashchange",()=>e.exitMemberFilterMode())}isOnline(){return $e.isTestEnv&&window.bryntum.algoliaOfflineMode===!0?!1:navigator.onLine}onSearchInput(s){let{offlineSearchHits:e,onlineSearchHits:t}=this.widgetMap;!navigator.onLine&&!e.isVisible&&(e.show(),t.hide()),this.onlineSearch(s),this.offlineSearch(s),this.showHideWidgets(s)}onCategoryClick({record:s}){let{offlineSearchHits:e,onlineSearchHits:t,searchCategories:i}=this.widgetMap,r=i.selected.includes(s.id);return s.id==="offline"&&!e.isVisible?(t.hide(),e.show()):s.id==="offline"&&e.isVisible?(e.hide(),t.show(),i.deselectAll()):s.id!=="offline"&&(e.hide(),t.show(),this.onlineCategoryClickFunction(s.id)),i.deselectAll(),r||i.select(s.id),!1}initializeOnlineSearch(){let s=this,{widgetMap:e,settings:t}=s,{searchCategories:i,onlineSearchHits:r,offlineSearchHits:n}=e,{connectSearchBox:l,connectMenu:o,connectRefinementList:c,connectInfiniteHits:p}=instantsearch.connectors,u=l((f,g)=>{g&&(s.onlineSearch=f.refine)}),m=o((f,g)=>{let{items:b,refine:y}=f;g&&(s.onlineCategoryClickFunction=E=>{i.deselectAll(),y(E)}),s.updateCategories(b)}),h=c(f=>{let{items:g,refine:b}=f;["public","private","internal"].forEach(y=>{let E=t["show"+y.charAt(0).toUpperCase()+y.slice(1)],H=g.find(x=>x.value===y);H&&H.isRefined!==E&&b(y)})}),d=p((f,g)=>{let{hits:b,isLastPage:y,showMore:E,instantSearchInstance:H}=f,x=H.renderState[pe].searchBox.query,v=[...b];if(g&&(s.showMoreFunction=()=>{s.onlineSearchHitsNumOfItems=r.items.length-1,E()}),!i.selected.includes("offline")&&!r.isVisible&&(r.show(),n.hide()),v.length===0&&B.status==="idle"&&x.length>0&&(v.push({recordType:"noResults"}),r.hide(),n.show()),!y&&v.length>=20&&v.push({recordType:"showMore"}),r.items=v,s.onlineSearchHitsNumOfItems&&b.length>s.onlineSearchHitsNumOfItems){let C=r.getItem(s.onlineSearchHitsNumOfItems);r.navigator.changeActiveItem(C),C.focus(),s.onlineSearchHitsNumOfItems=null}});B.addWidgets([u(),m({attribute:"category"}),d(),h({attribute:"access"})]),B.start()}showSearch(){let s=this,{widgetMap:e,memberFilterMode:t,owner:i}=s,{globalSearch:r,searchField:n,searchCategories:l}=e;s.currentHistoryIndex=-1,t&&(n.value=i.memberFilter.value),l.deselectAll(),r.show(),this.showHideWidgets("")}async hideSearch(s=!0){let{isOnline:e,widgetMap:t,memberFilterMode:i,onlineSearchInitialized:r}=this,{globalSearch:n,searchField:l}=t;s&&!i&&(l.value="",this.showHideWidgets(""),e()&&r&&B.setUiState({[pe]:{query:""}})),n.hide()}showHideWidgets(s){let{globalSearch:e,searchCategories:t,onlineSearchHits:i,offlineSearchHits:r,searchPreSearch:n}=this.widgetMap;s.length<1?(t.hide(),i.hide(),r.hide(),this.memberFilterMode||n.show(),e.contentElement.style.overflowY="scroll"):(t.show(),t.selected.includes("offline")?(r.show(),i.hide()):(r.hide(),i.show()),n.hide(),e.contentElement.style.overflowY="")}updateSearchQuery(s){let{widgetMap:e}=this,{searchField:t}=e;t.value=s,B.setUiState({[pe]:{query:s}}),this.showHideWidgets(s)}prevQuery(){let s=this,e=JSON.parse(localStorage.getItem("recentSearchQueries"))||[];s.currentHistoryIndex<e.length-1&&(s.currentHistoryIndex++,s.updateSearchQuery(e[s.currentHistoryIndex]))}nextQuery(){let s=this,e=JSON.parse(localStorage.getItem("recentSearchQueries"))||[];s.currentHistoryIndex>0?(s.currentHistoryIndex--,s.updateSearchQuery(e[s.currentHistoryIndex])):s.currentHistoryIndex===0&&(s.currentHistoryIndex--,s.updateSearchQuery(""))}offlineSearch(s){let{offlineSearchHits:e}=this.widgetMap;_.filter({id:"offlineFilter",filterBy:t=>{let i=s.toLowerCase().trim();return i.length<1?!1:i.length<3?t.title.toLowerCase()===i:ye(i.split(" "),t.fullName.toLowerCase())}}),_.count===0?e.items=[{recordType:"noResults"}]:e.items=_.records}updateCategories(s){let e=["api","guide","example"],t=[],i=[],{searchCategories:r}=this.widgetMap,n=new Map(s.map(l=>[l.value,l]));e.forEach(l=>{let o=n.get(l)||{count:0,isRefined:!1};o.count>0&&(t.push({id:l,label:ve[l],count:o.count}),o.isRefined&&i.push(l))}),t.push({id:"offline",label:`${ve.offline}`,count:_.count}),r.items=t,r.selected=i}preSearchTemplate(s,e,t){if(s.isGroupHeader)return t.constructor.prototype.itemWrapperTpl.call(t,...arguments);if(s.data.recordType==="Suggested"){let{data:i}=s,r=i.hash||i.path,n=r?`${r.startsWith("#")?"":"#"}${r}`:i.href,l=we(n,location),o=l.origin!==location.origin||l.pathname!==location.pathname,c=`class="${t.getItemClasses(s,e)} suggested-item"`,p=o?`href="${n||"#"}" target="_blank rel="noopener"`:`href="${n}"`,u=`${c} role="option" ${p} aria-selected="${t.selected.includes(s)}" data-index="${e}" data-id="${$.encodeHtml(s.id)}"`,{icon:m,title:h,description:d}=i;return`
                <a ${u}>
                    <div class="icon">
                        <i class="b-fa ${m}"></i>
                    </div>
            ...
            `}else return this.hitItemTemplate(...arguments)}hitItemTemplate(s,e,t=this.widgetMap.onlineSearchHits){let{data:i}=s,r=i.hash||i.path,n=r?r.startsWith("#")||r.startsWith("../")||r.startsWith("./")||r.startsWith("/")?r:"#"+r:i.href,l=we(n,location),o=l.origin!==location.origin||l.pathname!==location.pathname,c=`${t.getItemClasses(s,e)}`,p=o?`href="${n||"#"}" target="_blank rel="noopener"`:`href="${n}"`,u=i.recordType==="noResults"||i.recordType==="showMore",m=`role="option" ${u?"":p} aria-selected="${t.selected.includes(s)}" data-index="${e}" data-id="${$.encodeHtml(s.id)}"`,h=S=>{let{title:M,clsFullName:L,type:P}=S;return Pe.docsTpl`
                <a ${m} class="${c} recentSearch hit" data-noselect="true">
                    <div class="hit-header">
                        <div class="left">
                            <span class="hit-title">${$.encodeHtml(M)}</span>
                            <span class="hit-path">${$.encodeHtml(L)}</span>
                        </div>
                        <span class="hit-badge ${$.encodeHtml(P)}">${$.encodeHtml(P[0].toUpperCase()+P.slice(1))}</span>
                    </div>
                </a>`};if(i.recordType==="noResults")return`<a ${m} class="${c} hit no-results">No results found</a>`;let{recordType:d,category:f,path:g,title:b,access:y,type:E,description:H,isRecentSearch:x,image:v,parentName:C}=i;if(d==="showMore")return`
                <a ${m} class="${c} showMoreButton">Show More</a>
            `;if(f==="api"){if(x)return h(i);let S=g.replace(/#.*?-(.*)/,"/$1");return`
                <a ${m} class="${c} hit">
                    <div class="hit-header">
                        <div class="left">
                            <span class="hit-title">${$.encodeHtml(b)}</span>
                            <span class="hit-path">${$.encodeHtml(S)}</span>
                        </div>
                        ${y!=="public"?`<span class="hit-badge">${$.encodeHtml(y[0].toUpperCase()+y.slice(1))}</span>`:""}
                        <span class="hit-badge ${$.encodeHtml(E)}">${$.encodeHtml(E[0].toUpperCase()+E.slice(1))}</span>
                    </div>
                    <div class="hit-description">${$.encodeHtml(H)}</div>
                </a>`}else if(f==="example"){let S=[],M=b.toLowerCase();["react","vite","vue","angular"].forEach(P=>{M.includes(P)&&S.push(`data/Core/images/logo/${P}.svg`)}),S.length||S.push("data/Core/images/logo/js.svg");let L=S.map(P=>`<img class="framework-badge" src="${$.encodeHtml(P)}"/>`).join(" ");return x?`
                    ...
                    <a ${m} class="${c} hit with-image">
                        <div class="hit-image-container">
                            ${$e.isTestEnv?"":`<img src="${$.encodeHtml(v)}"/>`}
                        </div>
                    ...
                    </a>`}else if(f==="guide"){if(x)return h(i);let S=C===b||!b,M=S?$.encodeHtml(C):`${$.encodeHtml(C)} > ${$.encodeHtml(b)}`;return`
                <a ${m} class="${c} hit">
                    <div class="hit-header">
                        <span class="hit-title">${M}</span>
                        <span class="hit-badge guide">Guide</span>
                    </div>
                    <div class="hit-description">${$.encodeHtml(H)}</div>
                </a>`}else{if(x)return h(i);let{title:S,clsFullName:M,type:L,description:P}=i;return Pe.docsTpl`
                <a ${m} class="${c} hit" data-noselect="true" data-is-offline-record="true">
                    <div class="hit-header">
                        <div class="left">
                            <span class="hit-title">${$.encodeHtml(S)}</span>
                            <span class="hit-path">${$.encodeHtml(M)}</span>
                        </div>
                        <span class="hit-badge ${$.encodeHtml(L)}">${$.encodeHtml(L[0].toUpperCase()+L.slice(1))}</span>
                    </div>
                    <div class="hit-description">${$.encodeHtml(P)}</div>
...
<div class="summary-items ${a.title}">
    ...
    `)}
</div>`;var ps={configs:"config",properties:"property",functions:"function",events:"event",fields:"field",typedefs:"typedef"},Q=class extends ds{static get defaultConfig(){return{textContent:!1,forElement:document.getElementById("content"),forSelector:".summary > .summary-icon:not(.none)",allowOver:!0,cls:"summary-tooltip",scrollable:{overflowY:!0},header:{dock:"top",cls:"summary-title",titleAlign:"center"},scrollAction:"realign"}}onBeforeShow(){let s=this.activeTarget,e=this.store.getById(window.bryntum.router.id),t=s.id.substring(8);this.populate(e,t)}populate(s,e){let t=this,i=s.data,r={recordData:i,data:i[e].sort((l,o)=>l.name<o.name?-1:1),type:e,prefix:ps[e],title:e.substring(0,1).toUpperCase()+e.substring(1)},{headerElement:n}=t;n.classList.remove(t.contentType),n.classList.add(r.type),t.contentType=r.type,t.title=r.title,t.html=window.bryntum.router.adjustHtmlLinks(ze(r))}};w(Q,"$name","SummaryTooltip");Q._$name="SummaryTooltip";import{BrowserHelper as Se}from"./setup.js";var te=class{constructor(){let s=this,{queryString:e}=Se;window.bryntum.isBryntumOnline=s.isBryntumOnline=Se.isBryntumOnline(),s.isPrerender=e.prerender!=null,window.bryntum.isOnline=s.isOnline=s.isBryntumOnline||e.online!=null||!!s.headBase,window.onpopstate=()=>{window.bryntum.isOnline&&window.onhashchange()}}get navLocation(){var r,n;let s={},{hash:e}=window.location,t=e&&e!=="#"&&decodeURIComponent(e.replace("#","")),{pathname:i}=window.location;if(i=i.endsWith("/")?i.slice(0,-1):i,i.includes("/api/"))s.id=i.split("/api/")[1],s.anchor=t;else if(i.includes("/guide/")){let l=i.split("/guide/")[1];if(l==="upgrade-guide")s.id=l;else{let o=/(.*?\/)(.*)/.exec(l);o!=null&&o[2]?l.startsWith("engine/")?s.id=`../${o[1]}${o[2]}.md`:["licenses","overview","changelog"].includes(o[2])?s.id=`${o[1]}${o[2]}.md`:s.id=`${o[1]}guides/${o[2]}.md`:s.id=l}s.anchor=t}else if(e){let l=t.split("#");s.id=l[0],s.anchor=l[1],(r=s.id)!=null&&r.startsWith("guides/")&&(s.id=`${window.productName}/${s.id}`)}return s.id&&((n=window.linkAliases)!=null&&n[s.id])&&(s.id=window.linkAliases[s.id]),s}get id(){return this.navLocation.id}get anchor(){return this.navLocation.anchor}isRouteLink(s){return!!["api/","guide/"].find(e=>s.startsWith(e))}get headBase(){var s;return(s=document.head.querySelector("base"))==null?void 0:s.getAttribute("href")}get baseUrl(){let s=this.headBase;return s&&!s.startsWith("http")&&(s=`${window.location.protocol}//${window.location.host}${s}`),s}routeTo(s){if(!this.isOnline||!this.baseUrl||!s||/^(http|\.+\/|\/)/.test(s))return;let e=new URL(`${this.baseUrl}${s}`);return["online","prerender"].forEach(t=>{Se.queryString[t]!=null&&e.searchParams.set(t,"true")}),window.history.pushState({},s,e.toString()),window.onhashchange(),!0}routeToHash(s){this.routeTo(this.getRoute(s))}getRoute(s){var e;if(s!=null&&s.includes("#")){if(["#","#guides","#download-npm","#what-s-new","#integration"].includes(s))return s;if(s.includes("guides/")){let t=/#(.*?)\/guides\/(.*)?/.exec(s);if(t)return`guide/${t[1]}/${t[2].replace(".md","")}`}if(/#\S+\.md/.test(s))return s.replace(/#[./]+/,"#").replace(/#(\S+)\.md/,"guide/$1");if(s.startsWith("#"))return s.replace("#","api/")}return s&&(s==="../examples"&&this.isOnline&&((e=this.headBase)!=null&&e.includes("-next")?s=`/products/${window.product}-next/examples/`:s=`/products/${window.product}/examples/`),s.includes("examples/")&&!s.includes("#")&&!s.includes("?")&&!s.endsWith("/")&&(s=`${s}/`)),s}adjustDomLinks(){this.isOnline&&document.querySelectorAll("a").forEach(s=>{let e=this.getRoute(s.getAttribute("href"));e&&s.setAttribute("href",e)})}adjustHtmlLinks(s){return this.isOnline?s.replace(/(href|src)="(\S*?)"/gm,(e,t,i)=>`${t}="${this.getRoute(i)}"`):s}adjustStoreLinks(s){this.isOnline&&s.allRecords.forEach(e=>{let t=this.getRoute(e.href);t&&(e.href=t)})}};te._$name="Router";import{EventHelper as us,Tooltip as ms}from"./setup.js";var K=class extends ms{static get defaultConfig(){return{forElement:document.getElementById("content"),forSelector:".sectionHeader i"}}construct(){super.construct(...arguments),us.on({element:this.element,click:"hide",thisObj:this})}onBeforeShow(){let s=this.activeTarget;this.html=s.dataset.tooltip}};w(K,"$name","SectionTooltip");K._$name="SectionTooltip";import{Tooltip as fs}from"./setup.js";var Y=class extends fs{static get configurable(){return{forElement:document.getElementById("content"),forSelector:".type-differs a, .type-differs i",textContent:!0,scrollAction:"realign",cls:"type-tooltip"}}onBeforeShow(){let s=this.activeTarget.parentElement,{name:e}=s.dataset,t=s.parentElement.matches(".field"),i=this.app.currentRecord.data[t?"fields":"properties"].find(n=>n.name===e),r=t?["Load type","Return type"]:["Set type","Get type"];i&&(this.html=`
                <div class="label">${r[0]}</div><div class="accepts">${i.accepts.join(" / ")}</div>
                <div class="label">${r[1]}</div><div class="output">${i.type.join(" / ")}</div>
            `)}};w(Y,"$name","TypeTooltip");Y._$name="TypeTooltip";import{TemplateHelper as Fs}from"./setup.js";import{TemplateHelper as Ze}from"./setup.js";var N=a=>{if(!a.inheritedFrom)return"";let s=a.inheritedFrom.split("/"),e=s[s.length-1];return`<a href="#${a.inheritedFrom}" class="inherited" title="Defined in ${a.inheritedFrom}">${e}</a>`};import{StringHelper as Hs,TemplateHelper as xe}from"./setup.js";import{ArrayHelper as hs,StringHelper as gs,TemplateHelper as bs}from"./setup.js";var Ke='<span class="separator">/</span>',ys="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/",ws="https://developer.mozilla.org/en-US/docs/Web/API/",$s="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/",vs=["Array","Boolean","Date","Error","Function","Map","Number","Object","Promise","Set","Storage","String","Symbol","null","undefined"],Qe={Class:"Classes",TemplateStringsArray:"Template_literals"},Cs={GridColumnConfig:{cls:"Grid.column.Column",tip:"An object with a <code>type</code> property used to determine what kind of column to use + configs for that column.",snippet:"{ type : 'date', format : 'YYMMDD' }"},InputFieldConfig:{cls:"Core.widget.Field",tip:"An object with a <code>type</code> property used to determine what kind of field to use + configs for that field.",snippet:"{ type : 'textfield', label : 'Name' }"},ModelFieldConfig:{cls:"Core.data.field.DataField",tip:"An object with a <code>type</code> property used to determine what kind of data field to use + configs for that field.",snippet:"{ type : 'number', precision : 1 }"},ContainerLayoutConfig:{cls:"Core.widget.layout.Layout",tip:"An object with a <code>type</code> property used to determine what kind of layout to use.",snippet:"{ type : 'card' }"},ContainerItemConfig:{cls:"Core.widget.Widget",tip:"An object with a <code>type</code> property used to determine what kind of widget to create + configs for that widget.",snippet:"{ type : 'button', text : 'Click'}"}},Ss=/^(\w+(?:\.\w+)+)#(\w+)(\[])?$/,xs=/^Array\.<([^>]+)>$/,ae=a=>"#"+a.replace(/\./g,"/"),Ts=a=>window.docsClasses.find(s=>s.name===a),Es=a=>window.docsJson.typeDefs[a],Ye=a=>{var e;let s=a.split(".")[0];return(e=window.bryntum.docsOnline)!=null&&e.includes(s)?s:void 0},me=(a,s)=>{let e=Ye(a);return e?`https://bryntum.com/products/${e.toLowerCase()}/docs${s}`:s},U=(a,s,e,t)=>{var m,h;let i='target="_blank"',r="",n=a.toLowerCase();if(a instanceof Object)return(m=a.names)==null?void 0:m.map(U).join(Ke);if(a==="void")return a;if(a==="any")return"*";if(a.includes("'")||n==="null"||n==="false"||n==="true")return`<span class="type str">${a}</span>`;let l=xs.exec(a);if(l&&(a=l[1]),a.startsWith("{")){let d=a.match(/{(.*)}/)[1].split(", "),f=d.map(y=>{let[E]=y.split(": ");return`<span class="property">${E}</span>`}).join(", "),g=d.map(y=>{let[E,H]=y.split(": "),x=U(H,s,!1,t);return`<span class="property">${E}: ${x}</span>`});return`<span class="type" data-btip="${gs.encodeHtml(["Returns an object with the following properties:",...g].join("<br>"))}" data-btip-hide-delay="2000" data-btip-max-width="30em">{ ${f} }</span>`}if(a.startsWith("Object.<")){let d=a.match(/Object.<(.*)>/)[1].split(","),f=d[0],g=d[1];return g=g.trim(),g.startsWith("(")&&(g=g.substring(1,g.length-1)),g=g.split("|").map(b=>U(b,s,!1,t)).join(" | "),`<span class="type">Object<${U(f,s,!1,t)}, ${g}></span>`}if(a.includes("|")){let d=a.endsWith("[]")?"[]":"";return`<span class="type">(${a.replace("[]","").match(/^\((.*)\)$/)[1].split("|").map(b=>U(b,s,!1,t)).join("|")})${d}</span>`}if(a.match(/function\(.+\)/)){let d=a.match(/function\((.*)\)/)[1].split(","),f=d.map(y=>U(y,s,!1,t)).join(","),g=(h=a.match(/:(.*)/)[1])==null?void 0:h.trim(),b=g&&U(g,s,!1,t);return`<span class="type">Function(${f})${g?` : ${b}`:""}</span>`}a=a.trim().replace(/\(\)/g,"");let o=a.split("[")[0],c=Cs[o],p=o.split(".").pop();if(c){let{cls:d,tip:f,snippet:g}=c,b=me(d,ae(d))+"#configs",y=`${d.split(".").pop()}Config${a.endsWith("[]")?"[]":""}`;return`<a href="${b}" class="type" data-btip="${f}<br><br>For example:<br><code>${g}</code>">${y}</a>`}let u=Es(p);if(u)i="",r=ae(u.link);else if(p.endsWith("Config")&&p!=="Config"&&!p.includes("#")){if(Ye(a))r=me(a,ae(a.replace("Config","")));else{let d=p.replace("Config",""),f=Ts(d);if(!f)throw new Error(`Invalid class config reference: ${a}`);r=f.href}r=r+"#configs",a=p,i=""}else if(a.includes(".")){let d=Ss.exec(a);i="",d?(a=d[2]+(d[3]||""),r=`${ae(d[1])}#typedef-${d[2]}`):r=window.DocsBrowserInstance.fixClassLink(ae(a)),r=me(a,r),r=me(a,r),r=`${s||""}${r}`,a=a.split(".").pop()}else a!=="*"?(a!=="null"&&a!=="undefined"&&(a=a[0].toUpperCase()+a.substr(1)),Qe[a]?r=`${$s}${Qe[a]}`:r=(vs.indexOf(a.replace("[]",""))>=0?ys:ws)+a):i="";return r=r.replace("[]",""),e&&(a="..."+a),bs.docsTpl`<a ${i} class="type ${t?"output":""}" ${r?`href="${r}"`:""}>${a}${l?"[]":""}</a>`},k=(a,s=!0,e=!1,t=!1)=>{var c;let{type:i}=a;if(!i||i.length===0)return"";let r=hs.asArray(a.accepts||i),n=r.slice(0,5),l=r.slice(n.length),o=!!((c=a.accepts)!=null&&c.length);return o&&r.sort((p,u)=>i.includes(u)-i.includes(p)),(s?": ":"")+n.map(p=>{let u=o&&!a.isConfig&&i.includes(p);return U(p,void 0,t,u)}).join(Ke)+(l.length?`<span class="more-types" data-btip="${l.join(" / ")}" data-btip-cls="more-types-tip">+ ${l.length} more</span>`:"")+(o&&!a.isConfig?'<i class="b-fa b-fa-info-circle"></i>':"")+(e?'<div class="suffix">:</div>':"")};var A=(a,s="Parameters",e=!1)=>!(a!=null&&a.length)||e&&!a.some(t=>t.isSubParam)?"":xe.docsTpl`
    ${s?`<h3>${s}</h3>`:""}
    <ul class="parameters">
        ${a.map(t=>{var n;let i=t.name.split(".").pop(),r=(n=t.description)!=null?n:Hs.separate(i);return xe.docsTpl`
...
`};import{TemplateHelper as dt}from"./setup.js";var ct=(a,s)=>{var i;let e=(r,n,l=r.scope,o="property")=>(n?`#${n.fullName}#`:"")+`${o}-${encodeURIComponent(r.name)}${l==="static"?"-static":""}`,t=r=>{var n;return(n=a.configs)==null?void 0:n.some(l=>l.name===r)};return dt.docsTpl`
    ...
    `:""};import{TemplateHelper as He}from"./setup.js";var ks=(a,s)=>{let e=(t,i)=>(i?`#${i.fullName}#`:"")+`typedef-${encodeURIComponent(t.name)}`;return He.docsTpl`
    ...
    `},ft=a=>{var s;return(s=a.typedefs)!=null&&s.length?He.docsTpl`
    <section class="fields">
        <h2 class="sectionHeader">Type Definitions</h2>
        <ul>
            ${a.typedefs.map(e=>ks(e,a))}
        </ul>
    </section>
    `:""};import{TemplateHelper as Ae}from"./setup.js";var re,ne,ke=[],ht=(a,s)=>{var e;for(ke.length=0,re={},ne={};a;)(a.mixins||[]).forEach(t=>re[t.fullName]=1),(a.features||[]).forEach(t=>ne[t.fullName]=1),ke.push(a),a=((e=a.extends)==null?void 0:e.length)>0&&s.getById(a.extends[0]);return ke.reverse()},Ls=location.href.split("docs/")[0],Is=a=>bryntum.isLicensed?`href="${Ls}lib/${a.fullName.replace(/\./g,"/")}.js"`:"",gt=(a,s)=>Ae.docsTpl`
    ...
    <h3>Source path</h3>
    <a target="_blank" ${Is(a)} class="path">${a.fullName.replace(/\./g,"/")}.js</a>
    ...
    ${Object.keys(re).length>0?Ae.docsTpl`
    <div class="collapsible-ul">
        <input type="checkbox" id="toggle-mixins">
        <label for="toggle-mixins"><h3>Mixins<span class="count">${Object.keys(re).length}</span></h3></label>
        <ul class="inherited-mixins">
            ${Object.keys(re).sort().map(e=>`<li><a href="#${e}">${e.match(/([^/|.]+$)/)[0]}</a></li>`)}
        </ul>
    </div>
    `:""}
    ${Object.keys(ne).length>0?Ae.docsTpl`
    <div class="collapsible-ul">
        <input type="checkbox" id="toggle-features">
        <label for="toggle-features"><h3>Features<span class="count">${Object.keys(ne).length}</span></h3></label>
        <ul class="inherited-mixins">
            ${Object.keys(ne).sort().map(e=>`<li><a href="#${e}">${e.match(/([^/|.]+$)/)[0]}</a></li>`)}
        </ul>
    </div>
    `:""}
`;var{bryntum:bt}=window,yt=(a,s)=>Fs.docsTpl`
<header class="content-header">
    ...
    <div class="summary">
        ${a.demo?`<a id="demo-link" href="${bt.isOnline||a.demo.product!==bt.product?`https://bryntum.com/products/${a.demo.product}/examples`:"../examples"}/${a.demo.demo}" target="_blank"></a>`:""}
...
`;import{TemplateHelper as Ms}from"./setup.js";var Ds=new window.showdown.Converter({tables:!0,noHeaderId:!0}),wt=a=>{let{isVersionHistory:s,data:e}=a;return Ms.docsTpl`
        <div class="left-pane ${s?"b-no-counter":""}">${Ds.makeHtml(e.content)}</div>
        ${s?"":` 
        <div class="right-pane">
            <h3>Contents</h3>
            <ol class="toc contents-list"></ol>
        </div>`}
    `};import{StringHelper as Ns,TemplateHelper as Ps}from"./setup.js";var $t=(a,{name:s})=>{var n;let e=(n=a.parameters||[{name:"source",type:[s]}])==null?void 0:n.filter(l=>!l.name.includes(".")),t=l=>l.map(o=>{let c=o.split(".");return" : "+c[c.length-1]}).join("|"),i=a.onOwner?window.product:Ns.uncapitalize(s),r=l=>`${i}.on('${a.name}', ({ ${e.map(({name:o,type:c})=>o+(l?t(c):"")).join(", ")} }) => { 
...
${r(!0)}
        ...
        ${A(a.parameters,"",!1)}
    </div>`};import{StringHelper as vt,TemplateHelper as Rs}from"./setup.js";var Os=(a,s,e)=>`<pre class="prettyprint source lang-javascript"><code>new ${a}({
    ${s}({ ${e.map(({name:t,type:i})=>`${t} : ${i[0].split(".").pop()}`).join(", ")} }) {
    }
});</code></pre>`,Bs=(a,s,e)=>`<pre class="prettyprint source lang-javascript"><code>new ${a}({
    ${s}({ ${e} }) {
    }
});</code></pre>`,js=(a,s,e)=>`<pre class="prettyprint source lang-javascript"><code>const handler = useCallback(({ ${e} }) => {
});
...
`,Vs=(a,s,e,t)=>`<pre class="prettyprint source lang-html"><code>&lt;template>
    &lt;div>
...
`,Ws=(a,s,e)=>`<pre class="prettyprint source lang-html"><code>&lt;bryntum-${a.toLowerCase()}
    #${a.toLowerCase()}
    (${s}) = "${s}($event)"
...
`;import{TemplateHelper as Gs}from"./setup.js";import{TemplateHelper as _s}from"./setup.js";var Et=a=>_s.docsTpl`
...
`,Ht=Et;var qs=a=>{let s=[];return a.traverse(e=>{!e.isLeaf&&e.childLevel===2&&s.push(e)}),s},At=a=>Gs.docsTpl`
<h1>API Overview</h1>
<div class="content-body">
    ${a.children.map(s=>`
    <div class="rootnamespace">
        <h2>${s.name}</h2>
        <div class="namespace-child-wrap">${qs(s).map(e=>`<section>${Ht(e)}</section>`).join("")}
        </div>
    </div>`).join("")}
</div>
`;import{TemplateHelper as Us}from"./setup.js";var Js=a=>a.replaceAll(/[A-Z][a-z]+/g,s=>`${s}&ZeroWidthSpace;`),kt=(a,s)=>Us.docsTpl`
<h1>${a}</h1>
<div class="content-body">
    ${s.children.map(e=>`
...
`;import{TemplateHelper as zs}from"./setup.js";var Lt,It=a=>zs.docsTpl`
<h1>${a.name}</h1>
<div class="content-body">
    ${a.guidesRecords.map(s=>{let e=s.getGuideCategory(a),t=e&&e!==Lt?`<h2>${e}</h2>`:"";return Lt=e,`${t}
    <a href="${s.href}" class="b-card">
        <i class="${s.iconCls}"></i>
        <p>${s.name}</p>
    </a>`}).join("")}
</div>
`;import{TemplateHelper as Qs}from"./setup.js";var Ft=a=>Qs.docsTpl`
