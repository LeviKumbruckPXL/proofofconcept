...
const calendar = new Calendar({
    ...
    onRowHeightChange({
        ...
        (_this$activeView$zoom = (_this$activeView = this.activeView).zoomTo) === null || _this$activeView$zoom === undefined || _this$activeView$zoom.call(_this$activeView, source.value);
