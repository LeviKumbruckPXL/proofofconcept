import { Model, List, EventModel, Store, Calendar, StringHelper, DateHelper } from '../../build/calendar.module.js';
...
const projectStore  = new Store({
    ...
    dayWeekConfig = {
        ...
        eventRenderer       : ({ eventRecord }) => {
            const { projectInstance } = eventRecord;
            ...
            if (!eventRecord.isInterDay) {
                return [
                    ...
                    projectInstance ? {
                        ...
                        children : [
                            { tag : 'i', class : projectInstance.icon },
