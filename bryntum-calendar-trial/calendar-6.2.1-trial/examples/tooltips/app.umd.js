    ...
    features : {
        eventTooltip : {
            ...
            onBeforeShow() {
                ...
                this.tools.delete.hidden = Boolean((_this$eventRecord = this.eventRecord) === null || _this$eventRecord === undefined ? undefined : _this$eventRecord.isOccurrence);
