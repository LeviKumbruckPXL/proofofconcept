...
const startDate = '2023-10-09',
    ...
    // Start life looking at this date
                ...
                columns : [{
                    ...
                    renderer({
                        ...
                        return [{
                            ...
                            style     : `color:${(_record$resource = record.resource) === null || _record$resource === undefined ? undefined : _record$resource.eventColor}`
                        }, {
                            text : record.name
                        }];
                    }
        ...
        onRangeFieldChanged() {
            this.datePicker.selection = [this.widgetMap.startDate.value, this.widgetMap.endDate.value];
        },
