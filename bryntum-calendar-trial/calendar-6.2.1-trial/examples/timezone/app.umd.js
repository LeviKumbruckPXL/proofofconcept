        ...
        tbar : {
            items : {
                timezone : {
                    ...
                    // a local system date.
                    items          : ((_Intl$supportedValues = (_Intl = Intl).supportedValuesOf) === null || _Intl$supportedValues === undefined ? undefined : _Intl$supportedValues.call(_Intl, 'timeZone')) || timeZones,
