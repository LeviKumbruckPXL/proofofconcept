...
const locale = {
    ...
    Button : {
        ...
        Dec                  : 'Dez',
        Delete               : 'Excluir',
        Dualdayview          : 'Visualização de Dois Dias',
    ...
    Tooltip : {
        ...
        'Print the currently active view'                                     : 'Imprimir a visualização ativa atual',
        Saturday                                                              : 'Sábado',
        'Select admin mode to allow editing and rescheduling of performances' : 'Selecione o modo administrador para permitir a edição e reprogramação de apresentações',
