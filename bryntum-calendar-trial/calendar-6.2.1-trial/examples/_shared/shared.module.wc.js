import { LocaleHelper, Localizable, Base, GlobalEvents, AjaxHelper, AsyncHelper, BrowserHelper, DateHelper, DomHelper, StringHelper, DataGenerator, Fullscreen, Rectangle, VersionHelper, Events, Button, DemoCodeEditor, Toast, Tooltip, Widget, HintFlow } from '../../build/calendar.wc.module.js';
            ...
            codepenButton                 = new Button({
                ...
                async onClick({ source }) {
                    ...
                    const
                        ...
                        stylings    = (me.appConfig.index?.stylesheets ?? [])
                            ...
                            children : [{
                                ...
                                value : StringHelper.safeJsonStringify({
                                    ...
                                    html  : [
                                        '<html lang="en">',
                                        '<head>',
                                        `<link data-bryntum-theme="true" rel="stylesheet" href="https://bryntum.com/products/${productId}/build/${productId}.${themeName}.css?${hash}">`,
                                        `<link rel="stylesheet" href="${productUrl}/examples/_shared/shared.css?${hash}">`,
                                        stylings,
                                        '</head>',
                                        '<body>',
                                        htmlBody,
                                        me.localeManager.locale.localeName !== 'En' ? `<script src="https://bryntum.com/products/${productId}/examples/_shared/locales/examples.locale.${me.localeManager.locale.localeName}.umd.js?${hash}"></script>` : '',
                                        '</body>',
                                        '</html>'
                                    ].join('\n'),
                                    js : [
                                        `document.body.classList.add("b-theme-${themeName}"); // for styling purposes`,
                                        `import * as Module from '${productUrl}/build/${productId}.module.js?${hash}';`,
