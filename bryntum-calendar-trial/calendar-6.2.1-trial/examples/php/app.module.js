import { Calendar, Toast } from '../../build/calendar.module.js';
    ...
    tbar : {
        items : {
            ...
            resetButton : {
                ...
                async onAction() {
                    await Promise.all([
                        calendar.resourceStore.load({ reset : true }),
                        calendar.eventStore.load({ reset : true })
                    ]);
