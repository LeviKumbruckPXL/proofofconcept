import { EventModel, ResourceModel, Calendar, NumberFormat, StringHelper, DateHelper, ArrayHelper, Popup } from '../../build/calendar.module.js';
...
const calendar = new Calendar({
    ...
    performanceRenderer({ eventRecord, renderData }) {
        ...
        return [{
            ...
            text : `${isSmallDevice ? '' : 'From'} ${costFormatter.format(eventRecord.cost || eventRecord.resource?.minCost || 0)}`
        }];
    },
