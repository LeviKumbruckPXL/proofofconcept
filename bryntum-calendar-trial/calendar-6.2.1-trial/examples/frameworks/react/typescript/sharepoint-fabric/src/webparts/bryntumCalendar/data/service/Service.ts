...
import MyEventModel from '../model/EventModel';
import MyResourceModel from '../model/ResourceModel';
import { AssignmentModel } from '@bryntum/scheduler-thin';
...
export default class Service extends BaseService {
    ...
    constructor() {
        ...
        super({
            ...
            assignmentStore : { modelClass : AssignmentModel }
        });
            ...
            sp.web.lists.ensure(name, 'Bryntum demo', 171, true, {
                ...
                if (listEnsureResult.created) {
                    ...
                    if (sampleData === 'fulldemo') {
                        ...
                        await demoData.createSingleCalendarEvent(this.proxy, data.Id);
                    }
                }
                resolve(data.Id);
            }).catch(() => {});
