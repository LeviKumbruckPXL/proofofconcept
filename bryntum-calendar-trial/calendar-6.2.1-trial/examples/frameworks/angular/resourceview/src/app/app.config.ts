import { Calendar, Collection, ResourceFilter, ResourceModel, ResourceView, StringHelper, WeekView, Widget } from '@bryntum/calendar';
import { BryntumCalendarProps, BryntumWidgetProps } from '@bryntum/calendar-angular';
        ...
        view : {
            ...
            tools : {
                close : {
                    ...
                    handler(_event: Event, view: WeekView) {
                        const calendar           = view.up('calendar') as Calendar;
        ...
        items : {
            ...
            viewWidth : {
                ...
                onInput({ value, source }) {
                    const calendar = source.up('calendar') as Calendar;
